...
@InputType()
class FirewallRuleCreateNestedManyWithoutTenantsInput {
...
export { FirewallRuleCreateNestedManyWithoutTenantsInput as FirewallRuleCreateNestedManyWithoutTenantsInput };
